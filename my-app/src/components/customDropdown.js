	...
	this.state = {
	  ...
	  identity: 
		[{label: "Male", value: "male"},
                  ...
                  {label: "Choose Not to Identify", value: "other"}],
	  orientation: 
		[{label: "Male", value: "male"},
                  {label: "Female", value: "female"},
                  {label: "Choose Not to Identify", value: "other"}]
  ...
  changes(e) {
   ...
   render() {
	...
	return(
		...
		<Select options={ options } isMulti={this.state.multi} isSearchable={true} placeholder={this.props.placeholder} className={this.props.className} onChange={this.props.callback}/>
	      </div>
  	);
   }
}
